...
/**
 * NeoForge UI backend (spec §10.1-lite): recognized widget structures
 * (direct children of the active screen) + screen dispatch via the screen's
 * own event routing. Deeper semantic sources (nested trees, narration,
 * tooltips) land with full chunk 3.6.
 */
public final class NeoForgeUi implements ClientBridge.UiBackend {
    ...
    public boolean click(int x, int y) {
        ...
        if (consumed) {
            // Match the OS click pair so button-like widgets complete their
            // press/release cycle.
