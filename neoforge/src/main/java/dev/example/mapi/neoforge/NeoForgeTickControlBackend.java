...
/**
 * NeoForge tick-control backend backed by the vanilla
 ...
 */
final class NeoForgeTickControlBackend implements TickControlBackend {

    private final MinecraftServer server;

    NeoForgeTickControlBackend(MinecraftServer server) {
        this.server = server;
    }
    ...
    public Optional<StepResult> sprint(int ticks) {
        ...
        return Optional.of(new StepResult(ticks, 0, server.getTickCount()));
    }
